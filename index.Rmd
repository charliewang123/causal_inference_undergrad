...
In this course, students will: - Explore foundational concepts such as counterfactuals, causal estimands, and identification strategies. - Learn how to critically evaluate causal claims in public health literature. - Understand and apply experimental and observational study designs, causal diagrams (DAGs), and bias adjustment methods. - Develop practical skills through R-based tutorials and case studies.
...
This course will make use of: - **R** and **RStudio** - Interactive R tutorials and guided analysis - GitHub for accessing materials and submitting assignments
